    ...
    <div class="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
            ...
            <a class="block flex-shrink-0 lg:hidden" href="index.html">
                <img src="{{ asset('assets/image/logo/logo-icon.svg') }}" alt="Logo" />
            </a>
        </div>
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center gap-4" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
                    <span class="hidden text-right lg:block">
                        <span class="block text-sm font-medium text-black dark:text-white">{{ limit(auth()->user()->name, 12) }}</span>
                    </span>

                    <span class="h-12 w-12 rounded-full">
                        <img src="https://bootdey.com/img/Content/avatar/avatar1.png" class="rounded-full"
                            alt="User" />
                        {{-- <img src="{{ asset('assets/image/user/user-01.png') }}" alt="User" /> --}}
                    </span>
                ...
                <!-- Dropdown Start -->
                <div x-show="dropdownOpen"
                    class="absolute right-1 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                    <ul class="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
                        ...
                        @if (auth()->user()->root == 1)
                            <li>
                                <a href="{{ route("ativacao.empresa.index") }}" class="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
                                    <x-icons.contact />
                                    Todas as Empresas
                                </a>
                            </li>
