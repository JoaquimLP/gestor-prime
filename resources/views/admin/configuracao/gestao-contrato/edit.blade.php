    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        <div class="flex flex-col gap-9">
            <x-form.form-layout :route="route('configuracao.gestao-contrato.update', $gestaoContrato->id)" :method="'PUT'" :btnCancelRoute="route('configuracao.gestao-contrato.index')">
                ...
                <x-form.form-row class="gap-1">
                    <x-form.input-text class="my-2 mx-1 w-full lg:w-1/2" mask="99/99/9999" name="start_date" placeholder="" label="Vigência Início" :value="date_mask($gestaoContrato->start_date)" />
                    <x-form.input-text class="my-2 mx-1 w-full lg:w-1/2" mask="99/99/9999" name="end_date" placeholder="" label="Vigência Fim" :value="date_mask($gestaoContrato->end_date)" />
                </x-form.form-row>
