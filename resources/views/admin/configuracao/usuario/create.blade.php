<x-app-layout>
    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        <div class="flex flex-col gap-9">
            <x-form.form-layout :route="route('configuracao.usuario.store')" :method="'POST'" :btnCancelRoute="route('configuracao.usuario.index')">
                <x-form.form-col class="gap-1">
                    <x-form.input-text class="my-2 mx-1 w-full" name="name" placeholder="" label="Nome" value="" />
                </x-form.form-col>
                <x-form.form-row class="gap-1">
                    ...
                    <x-form.input-text class="my-2 mx-1 w-full lg:w-1/3" mask="99/99/9999" name="data_nascimento" placeholder="" label="Data de Nascimento" value="" />
                </x-form.form-row>
                <x-form.form-row class="gap-1">
                ...
                <x-form.form-row class="gap-1">
                    <x-form.input-select2 class="my-2 mx-1 w-full lg:w-1/2" :collection="$empresas" itemId="id" itemName="nome" name="empresa_id[]" :label="'Empresa'" value="" />
                </x-form.form-row>
            </x-form.form-layout>
        </div>
    </div>
